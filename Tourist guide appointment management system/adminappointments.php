...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/admin/adminbooking.css">
...
<div class="main-container">
    <div class="sidebar" id="sidebar">
            <ul>
                ...
                <a class="sidebar-appointment_button" href="adminappointments.php">
    ...
    <div class="main-content" id="main-content">
        ...
        <div class="adminappointments">
                <div class="title-searchbar_header">
                    <div class="adminappointments-header">APPOINTMENTS</div>
                    <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Search for bookings..">
                </div>
            <div class="adminappointments-table-contents">
